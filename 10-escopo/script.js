...
// CONST
// Mantém o escopo no bloco, impede a redeclaração e impede a modificação do valor da variável, evitando bugs no códig
const mes = 'Dezembro';
...
// console.log(var, marca, portas); Erro
console.log(cor); // Erro por causa do let e const que não vaza do bloco
